...
from app.handlers.purchases import delete_purchase
...
def delete(
    ...
    """Delete a purchase"""
    return delete_purchase(request=request, current_user=current_user, db=db, purchase_id=purchase_id)


@router.get("/purchases/{purchase_id}/delete", response_class=HTMLResponse)
def delete_compat(
    request: Request,
    current_user: Annotated[DBUser, Depends(get_current_user)],
    db: Annotated[Session, Depends(get_db)],
